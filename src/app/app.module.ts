...
import { ProfessionaContributionsComponent } from './components/professiona-contributions/professiona-contributions.component';
...
@NgModule({
  declarations: [
    ...
    HomeComponent,
    AboutMeComponent,
    ProfessionaContributionsComponent,
